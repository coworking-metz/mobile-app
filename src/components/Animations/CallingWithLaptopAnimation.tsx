...
const CallingWithLaptopAnimation: ForwardRefRenderFunction<LottieView, AnimationProps> = (
  ...
  const colorizedSource = useMemo(() => {
    const phoneRingingColor = theme.charlestonGreen;
    const phoneBackgroundColor = theme.meatBrown;
    const tableLegsColor = theme.meatBrown;

    const dotsColor = theme.charlestonGreen;
    const dotsBackgroundColor = theme.meatBrown;

    return colouriseLottie(CallingWithLaptop, {
      // b_hover-phone-ring..primary.design.Group 1.Fill 1
      'assets.0.layers.0.shapes.0.it.2.c.k': phoneRingingColor,
      // // b_hover-phone-ring..primary.design.Group 1.Fill 1
      'assets.0.layers.1.shapes.0.it.2.c.k': phoneRingingColor,
      // // b_hover-phone-ring..primary.design.Group 1.Stroke 1
      'assets.0.layers.2.shapes.0.it.1.c.k': phoneRingingColor,
      // // b_hover-phone-ring..primary.design.Group 1.Stroke 1
      'assets.0.layers.3.shapes.0.it.1.c.k': phoneRingingColor,
      // // b_hover-phone-ring..primary.design.Group 1.Stroke 1
      'assets.0.layers.4.shapes.0.it.1.c.k': phoneRingingColor,
      // // b_hover-phone-ring..primary.design.Group 1.Stroke 1
      'assets.0.layers.5.shapes.0.it.1.c.k': phoneRingingColor,
      ...
      // // Phone background
      'layers.2.shapes.0.it.1.c.k': phoneBackgroundColor,
      // // Dots.Group 1.Fill 1
      'layers.3.shapes.0.it.1.c.k': dotsColor,
      // // Dots.Group 2.Fill 1
      'layers.3.shapes.1.it.1.c.k': dotsColor,
      // // Dots.Group 3.Fill 1
      'layers.3.shapes.2.it.1.c.k': dotsColor,
      // // Dots.Group 4.Fill 1
      'layers.3.shapes.3.it.1.c.k': dotsBackgroundColor,
      ...
      'layers.5.shapes.1.it.1.c.k': tableLegsColor,
      // // Table.Group 3.Stroke 1
      'layers.5.shapes.2.it.1.c.k': tableLegsColor,
    });
  }, []);
