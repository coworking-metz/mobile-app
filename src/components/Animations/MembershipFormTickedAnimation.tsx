...
const MembershipFormTickedAnimation: ForwardRefRenderFunction<LottieView, AnimationProps> = (
  { ...props },
  ref,
) => {
  ...
  const colorizedSource = useMemo(() => {
    ...
    return colouriseLottie(MembershipFormTicked, {
      ...
      'assets.2.layers.0.shapes.0.it.1.c.k': paperColor,
      // Document.Page Line 2.Page Line.Stroke 1
      'assets.2.layers.1.shapes.0.it.6.c.k': linesColor,
      // Document.Page Front.Page Front.Fill 1
      'assets.2.layers.2.shapes.0.it.1.c.k': paperColor,
      // Document.Page Back 2.Page Back.Fill 1
      'assets.2.layers.3.shapes.0.it.1.c.k': backPaperColor,
      // Document.Page Back.Page Back.Fill 1
      'assets.2.layers.4.shapes.0.it.1.c.k': backPaperColor,
    });
  }, [colorScheme]);
...
export default forwardRef(MembershipFormTickedAnimation);
