...
const BarrierAnimation: ForwardRefRenderFunction<LottieView, AnimationProps> = (
  ...
  const colorizedSource = useMemo(() => {
    const iconColor = tw.prefixMatch('dark') ? tw.color('gray-200') : tw.color('gray-700');
    ...
    return colouriseLottie(LiftBarrier, {
      ...
      // 'layers.0.shapes.2.it.0.it.1.c.k': '#8b9ba9',
      // // 404-barrier Outlines.left-barrier.Group 15.Fill 1
      // 'layers.0.shapes.2.it.1.it.1.c.k': '#596775',
    });
  }, [colorScheme, color]);
