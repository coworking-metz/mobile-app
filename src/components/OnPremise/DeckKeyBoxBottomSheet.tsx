...
const DeckKeyBoxBottomSheet: ForwardRefRenderFunction<AppBottomSheetRef, AppBottomSheetProps> = (
  { style, onClose },
  forwardedRef,
) => {
  ...
  return (
    <AppBottomSheet
      ...
      onClose={onClose}>
      <KeyLockAnimation loop={false} style={tw`h-[144px] w-full`} />
      <AppText
...
export default forwardRef(DeckKeyBoxBottomSheet);
