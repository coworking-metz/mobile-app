...
- Toggle air conditioning and set target temperature from floor plan.
...
- First membership year on membership bottom sheet.
- Render when member is leaving location.

### Changed

- Group attending members by location.
...
- Hub meeting room bottom sheet on P'ti Poulailler plan.
- Add progress bar to temporary toast messages.

### Changed

- Rename `Ouvrir la barrière du parking` to `Ouvrir le parking`.
- Attendance count animation.
...
- Render ongoing events on home screen.

## [2026.2.1] - 2026-02-03

### Fixed

- Properly disconnect the user when stored tokens are invalid.
...
- Author on event screen.
- Suffix icon on links forwarding outside.
- Access WiFi credentials on floor plan.
...
- Background color above animation on home screen.
- Theme animation when opening bottom sheet.
- Event step animation on onboarding.
...
- Properly refresh automatically when app is active and device is connected to WiFi.
- Pictures artefacts.
...
- Chat with the team inside the app instead of external web browser.

## [2025.7.4] - 2025-07-16

### Added

- Markdown support in event description.
...
[unreleased]: https://github.com/coworking-metz/mobile-app/compare/2026.7.3...main
[2026.7.3]: https://github.com/coworking-metz/mobile-app/compare/2026.7.2...2026.7.3
[2026.7.2]: https://github.com/coworking-metz/mobile-app/compare/2026.7.1...2026.7.2
[2026.7.1]: https://github.com/coworking-metz/mobile-app/compare/2026.6.1...2026.7.1
[2026.6.1]: https://github.com/coworking-metz/mobile-app/compare/2026.5.3...2026.6.1
[2026.5.3]: https://github.com/coworking-metz/mobile-app/compare/2026.5.2...2026.5.3
[2026.5.2]: https://github.com/coworking-metz/mobile-app/compare/2026.5.1...2026.5.2
...
[2026.1.3]: https://github.com/coworking-metz/mobile-app/compare/2026.1.2...2026.1.3
...
[2025.7.3]: https://github.com/coworking-metz/mobile-app/compare/2025.7.2...2025.7.3
[2025.7.2]: https://github.com/coworking-metz/mobile-app/compare/2025.7.1...2025.7.2
[2025.7.1]: https://github.com/coworking-metz/mobile-app/compare/2025.6.2...2025.7.1
